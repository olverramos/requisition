function load_data(action, objectid) {
    ...
    if (action == 'edit') {
        ...
        document.getElementById("taker-form").action = objectid + '/edit/';
    ...
    if (action == 'delete') {
        ...
        document.getElementById("taker-form").action = objectid + '/delete/';
    }
    if (action == 'view') {
        verbose_action = 'Consulta de Tomador';
        document.getElementById("id_form_button").hidden = true;
        document.getElementById("taker-form").action = '.';
    }
    ...
    if (action == 'view' || action == 'delete') {
        ...
        document.getElementById('person_type_id').disabled = true;
        ...
        document.getElementById('person_type_id').disabled = false;
        ...
        ajaxRequest.onreadystatechange = function () {
            if (ajaxRequest.readyState == 4) {
                ...
                if (ajaxRequest.status == 200) {
                    ...
                    document.getElementById('id_contact_name').value = takers_obj.contact_name;
                    document.getElementById('person_type_id').value = takers_obj.person_type;
                    document.getElementById('document_type_id').value = takers_obj.document_type;
                }
                else {
