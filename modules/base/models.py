...
class Applicant(Document):
    ...
    phone_number = fields.StringField(verbose_name='Teléfono', unique=True)
    ...
    account = fields.ReferenceField('account.Account', verbose_name="Cuenta", null=True, blank=True)
